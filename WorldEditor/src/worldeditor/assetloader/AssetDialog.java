...
import com.opengg.core.model.ggmodel.process.GGTootle;
...
public class AssetDialog extends JDialog {
    ...
    class ModelTask extends SwingWorker<Integer,Tuple<Integer,Integer>>{
        ...
        GGModel m;
        JProgressBar bar;
        ModelTask(ModelProcess p, GGModel m,JProgressBar bar){
            this.p = p;
    ...
    public AssetDialog(JFrame parent) {
        ...
        button.addActionListener(e -> {
            ...
            try {
                ...
                GGModel model = AssimpModelLoader.loadModel(path);
